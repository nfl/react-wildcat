...
},{"./listen/listen_by_attributes":1,"./listen/listen_by_event_bindings":1,"./listen/listen_by_selectors":6,"./replay/replay_after_hydrate":1,"./replay/replay_after_rerender":9}],5:[function(require,module,exports){
"use strict";
...
},{"./buffer_manager":2,"./dom":3,"./event_manager":4,"./freeze/freeze_with_spinner":5,"./log":7}],9:[function(require,module,exports){
"use strict";
/**
...
;preboot.init({"appRoot":"body","freeze":{"name":"spinner","styles":{"overlay":{"className":"preboot-overlay","style":{"position":"absolute","display":"none","zIndex":"9999999","top":"0","left":"0","width":"100%","height":"100%"}},"spinner":{"className":"preboot-spinner","style":{"position":"absolute","display":"none","zIndex":"99999999"}}},"eventName":"PrebootFreeze","timeout":5000,"doBlur":true},"replay":[{"name":"rerender"}],"buffer":true,"debug":true,"uglify":false,"presets":["keyPress","buttonPress","focus"],"pauseEvent":"PrebootPause","resumeEvent":"PrebootResume","completeEvent":"BootstrapComplete","listen":[{"name":"selectors","eventsBySelector":{"input,textarea":["keypress","keyup","keydown","input","change"]}},{"name":"selectors","eventsBySelector":{"select,option":["change"]}},{"name":"selectors","preventDefault":true,"eventsBySelector":{"input[type=\"submit\"],button":["click"]},"dispatchEvent":"PrebootFreeze"},{"name":"selectors","eventsBySelector":{"input,textarea":["focusin","focusout","mousedown","mouseup"]},"trackFocus":true,"doNotReplay":true}]});
