...
export const firstFetchPromise = () =>
    Promise.resolve(prefetchedData.firstData);
export const secondFetchPromise = () =>
    Promise.resolve(prefetchedData.secondData);
export const arrayFetchPromise = () =>
    Promise.resolve(prefetchedData.asyncArrayData);
export const fetchPromiseCustomKey = () =>
    Promise.resolve(prefetchedDataCustomKey);
